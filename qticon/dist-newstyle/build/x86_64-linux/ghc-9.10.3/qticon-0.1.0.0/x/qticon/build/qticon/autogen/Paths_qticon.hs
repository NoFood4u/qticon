...
-- at runtime using the environment variable qticon_bindir.
...
-- environment variable qticon_libdir.
...
-- using the environment variable qticon_dynlibdir.
...
-- runtime using the environment variable qticon_datadir.
...
-- using the environment variable qticon_sysconfdir.
...
libdir     = "/home/user/.cabal/lib/x86_64-linux-ghc-9.10.3-7361/qticon-0.1.0.0-inplace-qticon"
dynlibdir  = "/home/user/.cabal/lib/x86_64-linux-ghc-9.10.3-7361"
datadir    = "/home/user/.cabal/share/x86_64-linux-ghc-9.10.3-7361/qticon-0.1.0.0"
libexecdir = "/home/user/.cabal/libexec/x86_64-linux-ghc-9.10.3-7361/qticon-0.1.0.0"
sysconfdir = "/home/user/.cabal/etc"

getBinDir     = catchIO (getEnv "qticon_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "qticon_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "qticon_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "qticon_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "qticon_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "qticon_sysconfdir") (\_ -> return sysconfdir)
